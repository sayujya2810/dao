            ...
            return(
              <div key={parseInt(proposal[0],16)} className="team_member card">
                ...
                <div style={{display:"flex", justifyContent:"space-between", marginTop:"9px"}}>
                  <a href={"https://ipfs.io/ipfs/" + decryptHex(proposal[8])} style={{border:"1px white solid", borderRadius:"3px", color:"white", padding:"3px", marginBottom:"3px", textDecoration:"none", width:"45%"}} target="_blank">Blueprint</a>
